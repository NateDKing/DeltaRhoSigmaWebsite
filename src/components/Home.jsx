  ...
  return (
    <div className="bg-primary-gray w-full min-h-screen m-0 p-0">
      ...
      <section className="mb-12">
        <div className="max-h-96 flex items-center justify-center relative overflow-hidden">
          <div className="absolute z-10 bg-white p-4 rounded shadow-lg to-30% left-30 opacity-80">
      ...
      <div className="mx-10vw mb-2rem">
        ...
        <section className="mb-12">
          <div className="flex items-center mb-6 justify-start">
            <h2 className="text-3xl font-bold text-primary-gold text-center flex-1">OUR VALUES</h2>
          </div>

          <div className="flex flex-col md:flex-row justify-center items-center">
            <div className="bg-transparent text-white border-4 border-primary-gold p-6 m-4 rounded-xl shadow-lg w-full md:w-1/3 text-center" >
        ...
        <section className="mb-12">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-2/3 mb-4 md:mb-0 md:pr-8">
              <h2 className="text-3xl font-bold mb-4 text-center text-primary-gold">WHAT IS D-RHO?</h2>
              <p className="text-white">Delta Rho Sigma (DRho) is a fraternity designed for students who seek to merge their entrepreneurial mindset with advanced engineering and business skills. It fosters a community that values integrity, innovation, and passion, aiming to equip its members to make a meaningful impact in the world.</p>
            </div>
            <div className="md:w-1/3 h-64 flex items-center justify-center overflow-hidden">
              <img src="/images/home-what.jpg" alt="What is D-Rho?" className="h-full w-full object-cover rounded-xl"/>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="flex flex-col md:flex-row-reverse items-center">
            <div className="md:w-2/3 mb-4 md:mb-0 md:pl-8">
              <h2 className="text-3xl font-bold mb-4 text-center text-white">JOIN D-RHO</h2>
        ...
        <section className="mb-12">
          <div className="flex flex-col items-center">
            <div className="flex items-center mb-6 justify-start w-full">
              <h2 className="text-3xl font-bold text-primary-gold text-center flex-1">D-RHO NEWSLETTER</h2>
            </div>
            <p className="text-white text-center mb-8">Get in touch with D-Rho and stay updated with our latest news and insights.</p>
            <form onSubmit={handleSubmit} className="w-full max-w-2xl bg-transparent border-4 border-primary-gold p-6 rounded-lg shadow-lg">
              ...
              <div className="mb-6">
                <label htmlFor="comment" className="block text-primary-gold text-sm font-bold mb-2">Comment</label>
                <textarea
                  id="comment"
                  name="comment"
